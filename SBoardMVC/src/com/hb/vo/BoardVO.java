...
public class BoardVO {
	...
	public String toString() {
		return "BoardVO [num=" + num + ", no=" + no + ", subject=" + subject + ", writer=" + writer + ", password="
				+ password + ", content=" + content + ", readhit=" + readhit + ", regdate=" + regdate + ", groupno="
				+ groupno + ", orderno=" + orderno + ", depth=" + depth + ", filepath=" + filepath + ", filename="
				+ filename + ", filesize=" + filesize + ", idx=" + idx + "]";
	}
